...
@UI: {
  headerInfo: { typeName: 'Task',
                ...
                title: { type: #STANDARD, label: 'Task', value: 'SemanticID' } } }

define view entity ZNBS_C_TASK
  as projection on ZNBS_I_TASK
{
  ...
  key     TaskUUID,
          ...
          @ObjectModel.virtualElementCalculatedBy: 'ZCL_DUEBY_DAYS_TASK'
  ...
  virtual dueby_char             : abap.char( 25 ),
          ...
          _Epic     : redirected to parent ZNBS_C_EPIC,
